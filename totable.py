...
def main():
    ...
    spark.sql("CREATE DATABASE IF NOT EXISTS auditlog")
    spark.sql("USE auditlog")

    # Ensure the 'data/' directory exists and contains Parquet files
    ...
    # Step 3: Create a Table in Spark Metastore (Schema Specified)
